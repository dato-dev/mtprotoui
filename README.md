...
- **Авто-ротация SNI** по расписанию (опционально, per-server)
...
- **Журнал действий** (аудит): кто/когда/что
...
- **TOFU-проверка SSH host-key**: ключ пиннится при первом подключении, при подмене соединение отклоняется
